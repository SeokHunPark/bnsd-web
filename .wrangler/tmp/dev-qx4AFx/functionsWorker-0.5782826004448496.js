...
// .wrangler/tmp/bundle-PXbs0V/checked-fetch.js
...
// .wrangler/tmp/pages-FUDI1h/functionsWorker-0.5782826004448496.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-lu1lNm/checked-fetch.js"() {
...
var init_verify = __esm({
  "api/pin/verify.js"() {
    init_functionsRoutes_0_5470838653243839();
    init_checked_fetch();
...
var require_he = __commonJS({
  "../node_modules/he/he.js"(exports, module) {
    ...
    (function(root) {
      ...
      var encode = /* @__PURE__ */ __name2(function(string, options) {
      ...
      var decode = /* @__PURE__ */ __name2(function(html, options) {
      ...
      var escape = /* @__PURE__ */ __name2(function(string) {
...
var require_comment = __commonJS({
  "../node_modules/node-html-parser/dist/nodes/comment.js"(exports) {
    ...
    var CommentNode = class _CommentNode extends node_1.default {
      static {
        __name(this, "_CommentNode");
      }
      static {
        __name2(this, "CommentNode");
      }
      clone() {
...
var require_boolbase = __commonJS({
  "../node_modules/boolbase/index.js"(exports, module) {
    ...
    init_checked_fetch();
    module.exports = {
      trueFunc: /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function trueFunc() {
        return true;
      }, "trueFunc"), "trueFunc"),
...
var require_commonjs = __commonJS({
  "../node_modules/css-what/lib/commonjs/index.js"(exports) {
    ...
    Object.defineProperty(exports, "isTraversal", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return parse_1.isTraversal;
    }, "get") });
    Object.defineProperty(exports, "parse", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return parse_1.parse;
    }, "get") });
    var stringify_1 = require_stringify2();
    Object.defineProperty(exports, "stringify", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
...
var require_attributes = __commonJS({
  "../node_modules/css-select/lib/attributes.js"(exports) {
    ...
    exports.attributeRules = {
      equals: /* @__PURE__ */ __name2(function(next, data, options) {
      ...
      hyphen: /* @__PURE__ */ __name2(function(next, data, options) {
        var adapter = options.adapter;
        var name = data.name;
        var value = data.value;
      ...
      element: /* @__PURE__ */ __name2(function(next, data, options) {
        var adapter = options.adapter;
      ...
      exists: /* @__PURE__ */ __name2(function(next, _a, _b) {
        var name = _a.name;
      ...
      start: /* @__PURE__ */ __name2(function(next, data, options) {
        var adapter = options.adapter;
        var name = data.name;
        var value = data.value;
        var len = value.length;
      ...
      end: /* @__PURE__ */ __name2(function(next, data, options) {
        var adapter = options.adapter;
        var name = data.name;
        var value = data.value;
        var len = -value.length;
      ...
      any: /* @__PURE__ */ __name2(function(next, data, options) {
        var adapter = options.adapter;
        var name = data.name, value = data.value;
        if (value === "") {
          return boolbase_1.default.falseFunc;
      ...
      not: /* @__PURE__ */ __name2(function(next, data, options) {
        var adapter = options.adapter;
        var name = data.name;
        var value = data.value;
        if (value === "") {
...
var require_lib6 = __commonJS({
  "../node_modules/nth-check/lib/index.js"(exports) {
    ...
    Object.defineProperty(exports, "compile", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return compile_js_1.compile;
    }, "get") });
    Object.defineProperty(exports, "generate", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
...
var require_filters = __commonJS({
  "../node_modules/css-select/lib/pseudo-selectors/filters.js"(exports) {
    ...
    exports.filters = {
      contains: /* @__PURE__ */ __name2(function(next, text, _a) {
        var adapter = _a.adapter;
        return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function contains(elem) {
          return next(elem) && adapter.getText(elem).includes(text);
        }, "contains"), "contains");
      }, "contains"),
      icontains: /* @__PURE__ */ __name2(function(next, text, _a) {
        var adapter = _a.adapter;
      ...
      "nth-child": /* @__PURE__ */ __name2(function(next, rule, _a) {
      ...
      "nth-last-child": /* @__PURE__ */ __name2(function(next, rule, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        var func = (0, nth_check_1.default)(rule);
        if (func === boolbase_1.default.falseFunc)
          return boolbase_1.default.falseFunc;
      ...
      "nth-of-type": /* @__PURE__ */ __name2(function(next, rule, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        var func = (0, nth_check_1.default)(rule);
        if (func === boolbase_1.default.falseFunc)
          return boolbase_1.default.falseFunc;
      ...
      "nth-last-of-type": /* @__PURE__ */ __name2(function(next, rule, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        var func = (0, nth_check_1.default)(rule);
        if (func === boolbase_1.default.falseFunc)
          return boolbase_1.default.falseFunc;
      ...
      root: /* @__PURE__ */ __name2(function(next, _rule, _a) {
        var adapter = _a.adapter;
        return function(elem) {
          var parent = adapter.getParent(elem);
          return (parent == null || !adapter.isTag(parent)) && next(elem);
      ...
      scope: /* @__PURE__ */ __name2(function(next, rule, options, context) {
    ...
    function dynamicStatePseudo(name) {
      return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function dynamicPseudo(next, _rule, _a) {
        var adapter = _a.adapter;
...
var require_pseudos = __commonJS({
  "../node_modules/css-select/lib/pseudo-selectors/pseudos.js"(exports) {
    ...
    exports.pseudos = {
      empty: /* @__PURE__ */ __name2(function(elem, _a) {
        var adapter = _a.adapter;
        return !adapter.getChildren(elem).some(function(elem2) {
          return adapter.isTag(elem2) || adapter.getText(elem2) !== "";
        });
      }, "empty"),
      "first-child": /* @__PURE__ */ __name2(function(elem, _a) {
        var adapter = _a.adapter, equals = _a.equals;
      ...
      "last-child": /* @__PURE__ */ __name2(function(elem, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        var siblings = adapter.getSiblings(elem);
        for (var i = siblings.length - 1; i >= 0; i--) {
          if (equals(elem, siblings[i]))
      ...
      "first-of-type": /* @__PURE__ */ __name2(function(elem, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        var siblings = adapter.getSiblings(elem);
      ...
      "last-of-type": /* @__PURE__ */ __name2(function(elem, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        var siblings = adapter.getSiblings(elem);
        var elemName = adapter.getName(elem);
        for (var i = siblings.length - 1; i >= 0; i--) {
      ...
      "only-of-type": /* @__PURE__ */ __name2(function(elem, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        var elemName = adapter.getName(elem);
      ...
      "only-child": /* @__PURE__ */ __name2(function(elem, _a) {
        var adapter = _a.adapter, equals = _a.equals;
        return adapter.getSiblings(elem).every(function(sibling) {
...
var require_subselects = __commonJS({
  "../node_modules/css-select/lib/pseudo-selectors/subselects.js"(exports) {
    ...
    var is = /* @__PURE__ */ __name2(function(next, token, options, context, compileToken) {
    ...
    exports.subselects = {
      ...
      matches: is,
      where: is,
      not: /* @__PURE__ */ __name2(function(next, token, options, context, compileToken) {
        var func = compileToken(token, copyOptions(options), context);
        return func === boolbase_1.default.falseFunc ? next : func === boolbase_1.default.trueFunc ? boolbase_1.default.falseFunc : function(elem) {
          return !func(elem) && next(elem);
        };
      }, "not"),
      has: /* @__PURE__ */ __name2(function(next, subselect, options, _context, compileToken) {
        var adapter = options.adapter;
...
var require_pseudo_selectors = __commonJS({
  "../node_modules/css-select/lib/pseudo-selectors/index.js"(exports) {
    ...
    Object.defineProperty(exports, "filters", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return filters_js_1.filters;
    }, "get") });
    var pseudos_js_1 = require_pseudos();
    Object.defineProperty(exports, "pseudos", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return pseudos_js_1.pseudos;
    }, "get") });
    var aliases_js_1 = require_aliases();
    Object.defineProperty(exports, "aliases", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
...
var require_lib7 = __commonJS({
  "../node_modules/css-select/lib/index.js"(exports) {
    ...
    var subselects_js_1 = require_subselects();
    var defaultEquals = /* @__PURE__ */ __name2(function(a, b) {
      return a === b;
    }, "defaultEquals");
    var defaultOptions = {
      adapter: DomUtils,
...
var require_html = __commonJS({
  "../node_modules/node-html-parser/dist/nodes/html.js"(exports) {
    ...
    function addToKBlockElement(...args) {
      const addToSet = /* @__PURE__ */ __name2((array) => {
    ...
    __name2(addToKBlockElement, "addToKBlockElement");
    ...
    var HTMLElement = class _HTMLElement extends node_1.default {
      static {
        __name(this, "_HTMLElement");
      }
      static {
        __name2(this, "HTMLElement");
      }
      /**
    ...
    function base_parse(data, options = {}) {
      ...
      __name2(element_should_be_ignore, "element_should_be_ignore");
      function is_block_text_element(tag) {
        return kBlockTextElements.some((it) => it.test(tag));
      }
      __name(is_block_text_element, "is_block_text_element");
      __name2(is_block_text_element, "is_block_text_element");
      const createRange = /* @__PURE__ */ __name2((startPos, endPos) => [startPos - frameFlagOffset, endPos - frameFlagOffset], "createRange");
      ...
      while (match2 = kMarkupPattern.exec(data)) {
        let { 0: matchText, 1: leadingSlash, 2: tagName, 3: attributes, 4: closingSlash } = match2;
    ...
    __name(resolveInsertable, "resolveInsertable");
    __name2(resolveInsertable, "resolveInsertable");
    ...
    __name2(resetParent, "resetParent");
  }
});
var require_parse3 = __commonJS({
  "../node_modules/node-html-parser/dist/parse.js"(exports) {
    ...
    Object.defineProperty(exports, "default", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return html_1.parse;
    }, "get") });
  }
});
...
async function onRequestGet({ request }) {
  ...
  try {
    const url = id ? `https://missa.cbck.or.kr/DailyMissa/${date}/${id}` : `https://missa.cbck.or.kr/DailyMissa/${date}`;
...
function parseMissaHtml(html, dateStr) {
  ...
  if (links.length > 0) {
    const masses = [];
    links.forEach((a) => {
      const match2 = a.getAttribute("href").match(/([0-9]+)$/);
      if (match2) {
        masses.push({
          id: match2[1],
...
__name(parseMissaHtml, "parseMissaHtml");
function extractSectionBody(section) {
  ...
  const filtered = texts.filter(
    (t) => !t.startsWith("\u25CE") && t !== "\uC8FC\uB2D8\uC758 \uB9D0\uC500\uC785\uB2C8\uB2E4."
  );
  return filtered.join("\n");
}
__name(extractSectionBody, "extractSectionBody");
...
var init_missa = __esm({
  "api/missa.js"() {
    init_functionsRoutes_0_5470838653243839();
    init_checked_fetch();
    import_node_html_parser = __toESM(require_dist());
    __name2(onRequestGet, "onRequestGet");
    __name2(parseMissaHtml, "parseMissaHtml");
    __name2(extractSectionBody, "extractSectionBody");
    __name2(formatDateString, "formatDateString");
  }
});
...
var routes;
var init_functionsRoutes_0_5470838653243839 = __esm({
  "../.wrangler/tmp/pages-FUDI1h/functionsRoutes-0.5470838653243839.mjs"() {
    init_verify();
    init_missa();
    init_sharing();
    init_sharing();
...
// .wrangler/tmp/bundle-PXbs0V/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-PXbs0V/middleware-loader.entry.ts
...
*/
//# sourceMappingURL=functionsWorker-0.5782826004448496.js.map
